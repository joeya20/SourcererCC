...
export RISCV=${PITON_ROOT}/../tools/openpiton_tools
...
cp $ARIANE_ROOT/openpiton/bootrom/baremetal/bootrom.sv.ct $ARIANE_ROOT/openpiton/bootrom/baremetal/bootrom.sv
